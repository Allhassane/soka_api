...
<head>
    ...
    <title> ONG IMPACTUM | Etudes réalisées </title>
    <!-- favicons Icons -->
    ...
    <meta name="description" content="Les differentes études réalisées par IMPACTUM">
...
<div class="page-wrapper">
    ...
    <section class="page-header">
        <div class="page-header-bg" style="background-image: url({{asset('assets/img/etude.jpg')}})">
        </div>
        <div class="container">
            <div class="page-header__inner">
                <h2>{{ __('etude.title') }}</h2>
            </div>
        </div>
    </section>
                    ...
                    <div class="col-xl-4 col-lg-4 wow slideInLeft" data-wow-delay="100ms"
                        ...
                        <div class="blog-one__single">
                            <div class="blog-one__img">
                                <img src="{{asset('assets/img/etudes')}}/{{$etude->picture}}" alt="">
                            </div>
                            <div class="blog-one__content">
                                <p class="texte_noir">
                                    <a href="{{route('etude.show',$etude->id)}}">
                            ...
                            @endif
                                ...
                                <a href="{{route('etude.show',$etude->id)}}" class="thm-btn main-slider-two__btn">
                                {{ __('slider.bouton') }}
                                <i
