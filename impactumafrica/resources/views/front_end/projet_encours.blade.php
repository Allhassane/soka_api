...
<head>
    ...
    <title> ONG IMPACTUM | Projets en cours de réalisation </title>
    <!-- favicons Icons -->
<link rel="apple-touch-icon" sizes="180x180" href="{{asset('assets/img/favicons/apple-touch-icon.png')}}" />
    ...
    <meta name="description" content="Les differents projets implémentés par IMPACTUM">
...
<div class="page-wrapper">
    ...
    <section class="page-header">
        ...
        <div class="container">
            <div class="page-header__inner">
                <h2>{{ __('menu.menu_projet_encours') }}</h2>
            </div>
        </div>
    </section>
    ...
    <section class="blog-one">
        <div class="container">
            <div class="row">
                @foreach($projets_actif as $projet)
                <div class="col-xl-4 col-lg-4 wow slideInRight" data-wow-delay="100ms"
                     data-wow-duration="2500ms">
                    <div class="blog-one__single">
                        <div class="blog-one__img">
                           {{-- <img src="{{asset('assets/img/projets')}}/{{$projet->picture}}" alt="">--}}
                        </div>
                        <div class="blog-one__content">
                            <p class="texte_noir text-center"><a href="{{route('projet.show',$projet->id)}}">
                            ...
                            <a href="{{route('projet.show',$projet->id)}}" class="thm-btn main-slider-two__btn">
                            {{ __('slider.bouton') }}
                            <i
