...
<head>
    ...
    <title> ONG IMPACTUM | Galerie des vidéos </title>
    <!-- favicons Icons -->
    ...
    <meta name="description" content="Les differentes vidéos de l'ONG IMPACTUM">
    ...
    <section class="page-header">
        ...
        <div class="container">
            <div class="page-header__inner">
                <h2> {{ __('menu.menu_mediatheque') }} - {{ __('menu.menu_video') }}</h2>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                @if($videos->count()>0)
                    ...
                    <div class="blog-one__single">
                        ...
                        <a href="{{ $video->url }}" class="thm-btn main-slider-two__btn" target="_blank">Voir la video<i
                ...
                @else
                    <h3 class="text-center text-success wow slideInLeft" data-wow-delay="100ms"
                        data-wow-duration="2500ms">{{ __('resultat.video') }}</h3>
                @endif
            </div>
        </div>
    </section>
