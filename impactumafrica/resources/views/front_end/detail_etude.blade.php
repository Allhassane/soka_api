...
<head>
    ...
    <title> ONG IMPACTUM | Detail de l'étude </title>
    <!-- favicons Icons -->
    ...
    <meta name="description" content="Detail des études implémentées par IMPACTUM">
...
<div class="page-wrapper">
    ...
    <section class="page-header">
        <div class="page-header-bg" style="background-image: url({{asset('assets/img/etudes')}}/{{$data->picture2}})">
        </div>
        <div class="container">
