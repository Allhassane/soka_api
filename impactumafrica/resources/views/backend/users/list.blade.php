...
@section('content')
    <div class="main-content">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        ...
                                        class="fas fa-plus fa-sm text-white-50"></i> Ajouter un utilisateur</button>
                                <br><br>
        ...
        @foreach($datas as $data)
            @include('components.admin.modals.users.delete')
            @include('components.admin.modals.users.edit')
        @endforeach
        @include('components.admin.modals.users.create')
    </div>
