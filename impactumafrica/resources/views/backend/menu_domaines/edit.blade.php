...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Modifier le domaine d'activité {{$data->title}}</h1>
                ...
                <form class="user" method="post" action="{{route('domaine.update',$data->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            ...
                            <input type="text" name="title" class="form-control form-control-user" value="{{$data->title}}" id="exampleFirstName"
                    ...
                    <center>
                        <button type="submit" class="btn btn-primary btn-user ">Mettre à jour le domaine d'activité</button>
