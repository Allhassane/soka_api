...
@section('content')
    ...
    <div class="main-content">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        ...
                                        class="fas fa-plus fa-sm text-white-50"></i> Ajouter un personnel</button>
                                <br><br>
                                        ...
                                        <table class="table table-striped table-hover" id="" style="width:100%;">
                                            ...
                                            @foreach($datas as $data)
                                                <tr>
                                                    <td>{{$data->id}}</td>
                                                    <td>{{$data->name}}</td>
                                                    <td><img src="{{asset('assets/img/personnel')}}/{{$data->picture}}" width="100" height="100" alt="">
                                                        <br>
                                ...
                                @else
                                    <h6 class="text-center">Aucun employe trouvé</h6>
                                @endif
                            </div>
                        </div>
                    </div>
        ...
        @foreach($datas as $data)
            @include('components.admin.modals.equipes.delete')
            @include('components.admin.modals.equipes.edit')
            @include('components.admin.modals.equipes.edit_picture')
        @endforeach
        @include('components.admin.modals.equipes.create')
    </div>
