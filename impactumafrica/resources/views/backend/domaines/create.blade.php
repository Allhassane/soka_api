    ...
    <div class="main-content">
        <section class="section">
            <ul class="breadcrumb breadcrumb-style ">
                ...
                <li class="breadcrumb-item active">Enregistrement des axes strategiques</li>
            </ul>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Enregistrement des axes strategiques</h4>
                            </div>
                            <div class="card-body">
                                <form class="user" method="post" action="{{route('domaine.store')}}" enctype="multipart/form-data">
                                    ...
                                    <center>
                                        ...
                                        <a href="{{route('domaine.list')}}" class="btn btn-danger">Annuler</a>                    </center>
                                </form>
                            </div>
                        </div>
                    </div>
