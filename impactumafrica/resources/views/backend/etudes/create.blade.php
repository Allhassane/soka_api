    ...
    <div class="main-content">
        <section class="section">
            <ul class="breadcrumb breadcrumb-style ">
                ...
                <li class="breadcrumb-item active">Enregistrement des etudes</li>
            </ul>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Enregistrement des etudes</h4>
                            </div>
                            <div class="card-body">
                                <form class="user" method="post" action="{{route('etude.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    <h5 class="text-danger">Information de l'etude</h5>
                            ...
                            <input type="file" name="picture" class="form-control form-control-user" id="exampleFirstName"
                                   placeholder="" required><br>
                                    ...
                                    <div class="">
                            <label for="">Choisir une image de detail(image large)</label>
                            <input type="file" name="picture2" class="form-control form-control-user" id="exampleFirstName"
                                   placeholder="" required ><br>
                                    ...
                                    <center>
                                        <button type="submit" class="btn btn-primary btn-user ">Enregistrer l'étude</button>
                                        <a href="{{route('etude.list')}}" class="btn btn-danger">Annuler</a>                    </center>
                                </form>
                            </div>
                        </div>
                    </div>
