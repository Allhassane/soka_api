    ...
    <div class="main-content">
        <section class="section">
            <ul class="breadcrumb breadcrumb-style ">
                ...
                <li class="breadcrumb-item active">Enregistrement des actualités</li>
            </ul>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Enregistrement des actualités</h4>
                            </div>
                            <div class="card-body">
                                <form class="user" method="post" action="{{route('actualite.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-4">
                                            <label for="">Choisir l'image de detail(1920*1076)</label>
