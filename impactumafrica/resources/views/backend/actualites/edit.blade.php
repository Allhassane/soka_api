    ...
    <div class="main-content">
        <section class="section">
            <ul class="breadcrumb breadcrumb-style ">
                ...
                <li class="breadcrumb-item active">Edition des actualités</li>
            </ul>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Edition des actualités</h4>
                            </div>
                            <div class="card-body">
                                <form class="user" method="post" action="{{route('actualite.update',$data->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <center>
                                        <button type="submit" class="btn btn-primary btn-user ">Editer une actualité</button>
                                        <a href="{{route('actualite.list')}}" class="btn btn-danger">Annuler</a>
                                    </center>
                                </form>
