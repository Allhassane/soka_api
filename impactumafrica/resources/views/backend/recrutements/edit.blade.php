    ...
    <div class="main-content">
        <section class="section">
            <ul class="breadcrumb breadcrumb-style ">
                ...
                <li class="breadcrumb-item active">Modifier le recrutements/appel d'offre: {{$data->title}}</li>
            </ul>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Modifier le recrutement</h4>
                            </div>
                            <div class="card-body">
                                      <form class="user" method="post" action="{{route('recrutement.update',$data->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group row">
                                        ...
                                        <div class="col-3">
                                            ...
                                            <input type="date" name="date_expiration" class="form-control form-control-user" id="exampleFirstName"
                                                   placeholder="" value="{{$data->date_expiration}}" required><br>
                                        </div>
                                        <div class="col-3">
                                    ...
                                    <center>
                                        <button type="submit" class="btn btn-primary btn-user ">Modifier un recrutement</button>
