...
@section('content')
    ...
    <div class="main-content">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        ...
                                        class="fas fa-plus fa-sm text-white-50"></i> Ajouter un partenaire</button>
                                <br><br>
                                        ...
                                        <table class="table table-striped table-hover" id="" style="width:100%;">
                                            ...
                                            @foreach($datas as $data)
                                                <tr>
                                                    <td>{{$data->id}}</td>
                                                    <td>{{$data->title}}</td>
                                                    <td><img src="{{asset('assets/img/partenaires')}}/{{$data->picture}}" width="100" height="100" alt=""></td>
                                                    <td>
                                ...
                                @else
                                    <h6 class="text-center">Aucun partenaire trouvé</h6>
                                @endif
                            </div>
                        </div>
                    </div>
        ...
        @foreach($datas as $data)
            @include('components.admin.modals.partenaires.delete')
            @include('components.admin.modals.partenaires.edit_picture')
        @endforeach
        @include('components.admin.modals.partenaires.create')
    </div>
