    ...
    <div class="main-content">
        <section class="section">
            <ul class="breadcrumb breadcrumb-style ">
                ...
                <li class="breadcrumb-item active">Edition des projets</li>
            </ul>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Modifier le projet {{$data->title}}</h4>
                            </div>
                            <div class="card-body">
                                <form class="user" method="post" action="{{route('projet.update',$data->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="title" class="form-control form-control-user" id="exampleFirstName"
                                                   placeholder="" value="{{$data->title}}" required>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="bailleur" class="form-control form-control-user" id="exampleFirstName"
                                                   placeholder="" value="{{$data->bailleur}}" required><br>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="info" class="form-control form-control-user" id="exampleFirstName"
                                                   placeholder="" required value="{{$data->info}}"><br>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="zone" class="form-control form-control-user" id="exampleFirstName"
                                                   placeholder="" value="{{$data->zone}}" required>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="date_projet" class="form-control form-control-user" id="exampleFirstName"
                                                   placeholder="" value="{{$data->date_projet}}" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label for="">Saisir les details</label>
                                            <textarea id="description" name="description" class="form-control"
                                                      rows="6" cols="" placeholder="Saisir les details" required>
                                                        {!! $data->description !!}
                                            </textarea>
                                        </div>
                                    </div>
                                    <center>
                                        <button type="submit" class="btn btn-primary btn-user ">Modifier le projet</button>
