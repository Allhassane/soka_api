    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                Vouler vous supprimer le contenu du sous axe {{$data->libelle}} de l'axe {{ $data->domaine->title }}?
            </div>
            <div class="modal-footer br">
                <a href="{{route('axe_item.delete',$data->id)}}" class="btn btn-success">Supprimer</a>
