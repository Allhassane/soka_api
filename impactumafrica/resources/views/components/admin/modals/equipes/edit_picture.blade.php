    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="user" method="post" action="{{route('equipe.updatePicture',$data->id)}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <div class="">
                            <img src="{{asset('assets/img/personnel')}}/{{$data->picture}}" width="100px" height="100px" alt="">
